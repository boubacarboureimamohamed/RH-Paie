...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><strong>{{ ('Ajout d\'une nouvelle direction') }}</strong></h1>
</div>
    ...
    <div class="card mb-4 py-3 border-left-primary">
      <div class="card-body">
        <div class="row">
            ...
            <div class="col-lg-6">
              <div class="p-5">
                <form class="user" method="POST" action="{{ route('directions.store') }}">
                    @csrf
                  ...
                  <div class="form-group">
                      <select name="departements_id" id="" class="form-control form-control-user">
