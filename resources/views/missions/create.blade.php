                ...
                <form class="user" method="POST" action="{{ route('missions.store') }}">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      ...
                      <input id="" type="date" class="form-control" name="date_debut_mission" value="" autofocus placeholder="Veillez entrer le nom de l'agent">
                    </div>
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <label for="">Date Fin :</label>
                        <input id="" type="date" class="form-control" name="date_fin_mission" value="" autofocus placeholder="Veillez entrer le prénom de l'agent">
                      </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
