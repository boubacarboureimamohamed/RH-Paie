                ...
                <form class="user" method="POST" action="{{ route('absences.update', $absence) }}">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      ...
                      <input id="" type="number" class="form-control" name="nombre_jour" value="{{ $absence->nombre_jour }}" autofocus placeholder="Veillez entrer le nombre de jour d'absence">
                    </div>
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <label for="">Motif :</label>
                        <textarea name="motif_absence" class="form-control" id="" cols="10" rows="1" placeholder="Veillez entrer le motif de l'absence">
