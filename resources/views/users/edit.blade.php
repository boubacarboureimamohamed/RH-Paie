                ...
                <form class="user" method="POST" action="{{ route('users.update', $user) }}">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      <input id="firstname" type="text" class="form-control form-control-user @error('firstname') is-invalid @enderror" name="firstname" value="{{ $user->firstname }}" required autocomplete="firstname" autofocus placeholder="Veillez entrer le nom">
                        @error('firstname')
                    ...
                    <div class="col-sm-6">
                        <input id="secondname" type="text" class="form-control form-control-user @error('secondname') is-invalid @enderror" name="secondname" value="{{ $user->secondname }}" required autocomplete="secondname" autofocus placeholder="Veillez entrer le prénom">
                        @error('secondname')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                  ...
                  <div class="form-group">
                    <input id="email" type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email" placeholder="Veillez enter l'adresse mail s'il vous plaît!">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <input id="password" type="password" class="form-control form-control-user @error('password') is-invalid @enderror" name="password" value="{{ $user->password }}" required autocomplete="new-password" placeholder="Confirmer mot de passe">
                        @error('password')
                           <span class="invalid-feedback" role="alert">
                               <strong>{{ $message }}</strong>
                           </span>
                    ...
                    <div class="col-sm-6">
                      <input id="password-confirm" type="password" class="form-control form-control-user" name="password_confirmation" value="{{ $user->password }}" required autocomplete="new-password" placeholder="Confirmer mot de passe">
                    </div>
                  </div>
                  <div class="form-group">
                    <!-- Multi-select start -->
