...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><strong>{{ ('Liste des affectations') }}</strong></h1>
</div>
    ...
    <div class="card mb-4 py-3 border-left-primary">
      <div class="card-body">
        <div class="btn-group btn-group-sm">
               <a href="{{ route('affectations.create') }}" class="btn btn-success" style="float: none;margin: 5px;">
